        ...
        <div className="bg-white rounded-2xl border border-[#E4E4E7] p-6 space-y-5">
            ...
            {waResult === 'error' && (
                <div className="flex items-center gap-2 text-sm p-3 rounded-lg bg-[#FEF2F2] text-[#EF4444]">
                    ...
                    <span>
                        {waReason === 'no_waba' ? 'No se encontró una cuenta de WhatsApp Business. Asegúrate de tener una WABA creada en Meta Business Suite.'
                            : waReason === 'token_failed' ? 'Error al obtener el token. Intenta de nuevo.'
            ...
            {waResult === 'connected' && (
                <div className="flex items-center gap-2 text-sm p-3 rounded-lg bg-[#ECFDF5] text-[#10B981]">
                    ...
                    <span>WhatsApp conectado{waPhone ? ` (${waPhone})` : ''}. Recarga para ver los cambios.</span>
                </div>
            )}

            <div className="space-y-3">
                <div className="bg-[#F4F4F5] rounded-lg p-4 space-y-2">
                    <p className="text-[13px] text-[#3F3F46]">Al conectar, podrás:</p>
                ...
                <p className="text-[12px] text-[#A1A1AA]">
                    Necesitas una cuenta de WhatsApp Business en Meta Business Suite.
                </p>
            </div>
